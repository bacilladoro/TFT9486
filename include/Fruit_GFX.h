...
class Fruit_GFX : public Print {

 public:

  Fruit_GFX(int16_t w, int16_t h); // Constructor
  ...
  // These exist only with Fruit_GFX (no subclass overrides)
  void
...
class Fruit_GFX_Button {

 public:
  Fruit_GFX_Button(void);
  // "Classic" initButton() uses center & size
  void initButton(Fruit_GFX *gfx, int16_t x, int16_t y,
   uint16_t w, uint16_t h, uint16_t outline, uint16_t fill,
   uint16_t textcolor, char *label, uint8_t textsize);
  // New/alt initButton() uses upper-left corner & size
  void initButtonUL(Fruit_GFX *gfx, int16_t x1, int16_t y1,
   uint16_t w, uint16_t h, uint16_t outline, uint16_t fill,
   uint16_t textcolor, char *label, uint8_t textsize);
...
class GFXcanvas1 : public Fruit_GFX {
 public:
...
class GFXcanvas8 : public Fruit_GFX {
 public:
...
class GFXcanvas16 : public Fruit_GFX {
 public:
