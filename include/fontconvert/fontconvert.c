/*
TrueType to Fruit_GFX font converter.  Derived from Peter Jakobs'
Adafruit_ftGFX fork & makefont tool, and Paul Kourany's Adafruit_mfGFX.

NOT AN ARDUINO SKETCH.  This is a command-line tool for preprocessing
fonts to be used with the Fruit_GFX Arduino library.
...
#include <ft2build.h>
#include FT_GLYPH_H
#include "gfxfont.h" // Fruit_GFX font structures
...
fonts (classic fonts unchanged).  See Fruit_GFX.cpp for explanation.
*/
